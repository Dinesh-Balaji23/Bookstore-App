...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://192.168.153.128:9000/login', userCredentials);
          ...
          <div className="collapse navbar-collapse">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item">
                <Link to="/login" className="nav-link active">User</Link>
              </li>
              <li className="nav-item">
                <Link to="/loginseller" className="nav-link">Seller</Link>
              </li>
              <li className="nav-item">
      ...
      <div className="d-flex justify-content-center align-items-center" style={{ height: "calc(100vh - 56px)" }}>
        <div className="card shadow" style={{ width: "400px", borderRadius: "10px" }}>
          <div className="card-body">
            <h3 className="text-center fw-bold mb-4">Login to User Account</h3>
